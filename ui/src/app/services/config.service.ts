...
export interface Config {
    ...
    llm_reasoning_effort: 'default' | 'disabled' | 'none' | 'minimal' | 'low' | 'medium' | 'high' | null;
    llm_api_key: string;
    llm_endpoint: string;
    ...
    agent_llm_reasoning_effort: 'default' | 'disabled' | 'none' | 'minimal' | 'low' | 'medium' | 'high' | null;
    ...
    overlay_vr_streamer_mode: boolean;
